  ...
  return (
    <div className="featured-wrap">
      ...
      <div className="featured-tracks">
        {playingState != null && <NowPlaying playingState={playingState} getSizedImageURL={getSizedImageURL} playMusic={playMusic} pauseMusic={pauseMusic} isPlaying={isPlaying} />}
