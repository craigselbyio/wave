...
const Track = ({ addToMusicQueue, getSizedImageURL, track, addToPlaylist, isInPlaylist }) => {

  return (
    <div onClick={() => addToMusicQueue(track)} className="track">
      <img className={isInPlaylist(track.id) ? "track-info-img track-in-playlist" : "track-info-img"} src={getSizedImageURL(track.attributes.artwork.url, "400")} alt="" />
